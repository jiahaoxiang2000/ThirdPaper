...
\begin{abstract}
  ...
  The FIPS 205 Stateless Hash-based Digital Signature Algorithm offers quantum resistance but faces performance bottlenecks impeding widespread implementation.
...
\begin{IEEEkeywords}
  Post-quantum cryptography, FIPS 205, Stateless hash-based signature, Parallel computing, GPU.
\end{IEEEkeywords}
